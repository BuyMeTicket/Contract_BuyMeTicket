...
contract Ticket is ITicket, ERC1155, Ownable {
    ...
    uint256[] public _mintPrices;
    uint256[] public _maxSupplys;
    ...
    */
    constructor(string memory _contractName, string memory _uri, string[] memory _names, uint256[] memory _ids)
        ERC1155(_uri)
    {
        names = _names;
        ids = _ids;
